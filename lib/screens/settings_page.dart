                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildToggleRow('Smell Quality', settings.showSmellQuality,
                          (value) => settings.showSmellQuality = value),
                      _buildToggleRow('Taste', settings.showTaste,
                          (value) => settings.showTaste = value),
                      _buildToggleRow('Taste Quality', settings.showTasteQuality,
                      ...
                      _buildToggleRow(
                          'Aftertaste Quality',
                          settings.showAftertasteQuality,
                      ...
                      const SizedBox(height: 8),
                      _buildToggleRow('Rating', settings.showRating,
